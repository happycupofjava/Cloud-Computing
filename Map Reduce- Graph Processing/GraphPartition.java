...
{ 
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException
    {
        ...
        long centroid; 
        int centroids_length= centroids.size();
        ...
        context.write(l, new Vertex(id, adjacent, centroid, srt));
}
}
